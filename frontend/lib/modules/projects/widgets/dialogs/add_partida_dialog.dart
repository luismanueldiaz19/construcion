...
class AddPartidaDialog extends StatefulWidget {
  const AddPartidaDialog({super.key});

  @override
  State<AddPartidaDialog> createState() => _AddPartidaDialogState();
}

class _AddPartidaDialogState extends State<AddPartidaDialog> {
            ...
            : Form(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      const Text('Datos de la Partida', style: TextStyle(fontWeight: FontWeight.bold)),
                      const SizedBox(height: 8),
                      TextFormField(
                        controller: _descripcionController,
                        decoration: const InputDecoration(labelText: 'Nombre de Partida', border: OutlineInputBorder()),
                        validator: (v) => v!.isEmpty ? 'Requerido' : null,
                      ),
                      const SizedBox(height: 16),
                      const Text('Primera Sub-partida', style: TextStyle(fontWeight: FontWeight.bold)),
                      const SizedBox(height: 8),
                      TextFormField(
        ...
        ElevatedButton(
          onPressed: _isSaving
              ...
              : () async {
                  ...
                  try {
                    await provider.projectService.addPartida(provider.proyecto!.id!, {
